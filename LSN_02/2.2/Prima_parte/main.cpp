...
int main (int argc, char *argv[]){
  ...
  ////////////////////////
   ...
   for(unsigned int i=0; i<k; i++){//Passi
     ...
     //Propagazione degli errori!!! Io conosco l'incertezza su r^2, non su r.

     //Ma r=sqrt(r^2), perciò dalla propagazione degli errori:
     //σ(r)=σ(r^2)/(2*sqrt(r^2))

     //Per l'errore relativo occore dividere un'altra volta per sqrt(r^2)=r
